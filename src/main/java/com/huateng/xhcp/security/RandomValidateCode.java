...
public class RandomValidateCode {
    private static final Log LOGGER = LogFactory.getLog(RandomValidateCode.class);
    ...
    private static volatile RandomValidateCode validateCode;
    private RandomValidateCode(){}

    public static RandomValidateCode getInstance(){
        if(validateCode == null){
            synchronized (RandomValidateCode.class){
                if(validateCode == null){
                    validateCode = new RandomValidateCode();
                }
            }
        }
        return validateCode;
