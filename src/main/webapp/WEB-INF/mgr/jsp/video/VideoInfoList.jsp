...
<body>
		            ...
		            <div class="box-inner">
		            	...
		            	<div class="modal-footer">
						    ...
						    <c:if test="${requestScope.page eq 'mgr'}">
							    <a href="${ctx}/mgr/video/add?module_id=${requestScope.module_id}&page=${requestScope.page}" class="btn btn-primary btn-sm">
		    ...
		    <div class="row">
		    	<div class="box col-md-12">
		            <div class="box-inner">
		            	<div class="box-content">
			            	<%-- 列表 --%>
							<table id="videoInfoList" class="table table-striped table-bordered" cellspacing="0" width="100%">
							    <thead>
							        <tr>
							        </tr>
							    </thead>
	...
	<%-- 加载JS --%>
	<script src="${ctx}/js/video/VideoInfoList.${__min}js"></script>
