...
<head>
	...
	<%request.setAttribute("import", "html5js,bootstrap,bootstrap_cerulean,charisma_app,paramCheck,jquery_dataTables,datetimepicker,jquery_noty,dateUtil,tableSupport,dialog,jquery_cookie,stringutil,form"); %>
...
<body>
		            ...
		            <div class="box-inner">
			                	...
			                	<div class="row">
			                	    ...
			                	    <div class="col-md-4">
			                		    ...
			                		    <div class="form-group">
			                		        ...
			                		        <input type="text" name="article_date" class="form-control" id="article_date" placeholder="<spring:message code="日期" />">
			                		    </div>
			                		</div>
			                	    <div class="col-md-4">
			                	    	<%-- 内容 --%>
			                		    <div class="form-group">
			                		        ...
			                		        <input type="text" name="contents" class="form-control" id="contents" placeholder="<spring:message code="内容" />">
			                		    </div>
			                		</div>
			                	</div>
		            	...
		            	<div class="modal-footer">
						    ...
						    <c:if test="${requestScope.page eq 'mgr'}">
							    <a href="${ctx}/mgr/article/add?module_id=${requestScope.module_id}&page=${requestScope.page}" class="btn btn-primary btn-sm">
	...
	<%-- 加载JS --%>
	<script src="${ctx}/js/article/ArticleList.${__min}js"></script>
